...
const FormField = memo(
  ({
    ...
    // const field = useWatch({ name: `customFields.${ki.index}` });
    ...
    // const formCustomFields: IFlatCustomField[] = useWatch({ name: 'customFields' });
    ...
    // const hasErrors = !!useWatch({ name: `customFields.${index}` })?.errors;
    // console.warn('Rerendering FormField');
    ...
    const editFieldAndValidate = () => {
      ...
      onEditField(field);
      trigger(`customFields.${field.index}`);
    };
...
FormField.whyDidYouRender = {
  logOnDifferentValues: true,
  customName: 'FormField',
};
