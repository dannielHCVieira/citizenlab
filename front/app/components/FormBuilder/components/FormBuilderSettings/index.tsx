...
const FormBuilderSettings = memo(
  ({ field, closeSettings, builderConfig, formHasSubmissions }: Props) => {
    const locales = useAppConfigurationLocales();
    const [currentTab, setCurrentTab] = useState<'content' | 'logic'>(
      'content'
    );
...
FormBuilderSettings.whyDidYouRender = {
  logOnDifferentValues: true,
  customName: 'FormBuilderSettings',
};
